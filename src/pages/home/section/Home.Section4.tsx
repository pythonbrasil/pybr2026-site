    ...
    return(<section className="Home_Section4" id="SUBMISSAO_DE_ATIVIDADES">
            <div className="Home_Section4_itens_texto">
                ...
                <div className="Home_Section4_itens_texto_buttons">
                    <a href="https://talks.python.org.br/pybr26/cfp" target="_blank"><button className="Home_Section4_buttons_1">{t("home.section4.enviarAtividade")}</button></a>
                    <a href="https://talks.python.org.br/pybr26/cfp" target="_blank"><button className="Home_Section4_buttons_2">{t("home.section4.regulamento")}</button></a>
                </div>
                <a href="https://instagram.com/pythonbrasil" target="_blank"><p>{t("home.section4.paragrafo1")}</p></a>
            </div>
